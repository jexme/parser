...
class AstrakhanSiteParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('#block-system-main .node-article');
        ...
        $descriptionCrawler = $contentCrawler->filterXPath('//div[contains(@class,"field-name-field-vrezka")]');
        if ($this->crawlerHasNodes($descriptionCrawler)) {
            $descriptionText = Text::trim($this->normalizeSpaces($descriptionCrawler->text()));
            if ($descriptionText) {
                $description = $descriptionText;
                $this->removeDomNodes($contentCrawler, '//div[contains(@class,"field-name-field-vrezka")]');
            }
        }

        $contentCrawler = $contentCrawler->filter('.field-name-body .field-item');
